...
<body class="handheld-toolbar-enabled container bg-dark">
        ...
        <header class="bg-light shadow-sm navbar-sticky">
            <div class="navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0 me-4 order-lg-1"
                        href="<?= roothtml.'index.php'?>"><img src="<?= roothtml.'lib/images/headlogo.jpg'?>" width="50"
                            alt="HITUPMM.COM" style="border-radius: 8px;"></a><a
