...
<div class="container">
    <div class="row pt-3">
        <div class="col-5">
            <h4 class=" m-4" style="color: white;"><a href="<?= roothtml . 'wallet/topup.php' ?>"><i
                        class="ci-reply"></i></a></h4>
        </div>
        <div class="col-7">
            <img src="<?=roothtml.'lib/images/wave.png'?>" alt="" class="rounded-circle"
...
<div align="center" class="m-3">
    ...
    <div class="alert alert-success" role="alert">
        <h6>Wave AccountName - TestUser</h6>
        <h6>
            WavePay No -
            <span id="kpay-number">09785466655</span>
            <span class="copy-container position-relative">
                <i class="ci-link" onclick="copyKpay()" style="cursor:pointer;"></i>
                <span id="copy-tooltip" class="copy-tooltip" style="display: none;">Copied!</span>
            </span>
        </h6>
    </div>
    <form class="pt-3" id="frmtopupwavepay" method="POST">
        <input type="hidden" name="action" value="topupwave" />
        <div class="input-group mb-2">
            <span class="input-group-text fw-medium">Wave Name</span>
            <input class="form-control" type="text" placeholder="WavePay Name" name="wavename" required>
        </div>
        <div class="input-group mb-2">
            <span class="input-group-text fw-medium">Wave No</span>
            <input class="form-control" type="number" placeholder="WavePay Number" name="waveno" required>
        </div>
        <div class="input-group mb-2">
        ...
        <div class="input-group mb-4">
            <span class="input-group-text fw-medium">TransactionNo</span>
            <input class="form-control" type="text" placeholder="TransactionNo" name="transactionno" required>
        </div>
        <div class="container">
            <div class="row">
...
$(document).ready(function() {
    ...
    $("#frmtopupwavepay").on("submit", function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == 1) {
                    swal({
                        title: "Success",
                        text: "Topup successful! Please wait to Confirm...",
                        icon: "success",
                        buttons: false,
                    ...
                    swal("Error", "Invalid wavename or waveno", "error");
                } else {
                    // Show any other unexpected output as error
                    swal("Error", "Topup failed: " + data, "error");
                    //alert(data);
                }
            }
        });
