...
<div align="center" class="m-3">
    <form class="pt-3" id="frmwithdrawwave" method="POST">
        <input type="hidden" name="action" value="withdrawwave" />
        ...
        <div class="input-group mb-2">
            <span class="input-group-text fw-medium">Waev No</span>
...
$(document).ready(function() {
    ...
    $("#frmwithdrawwave").on("submit", function(e) {
        e.preventDefault();
